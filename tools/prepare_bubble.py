...
# Delete-zone activation: trigger as soon as the bubble rectangle touches/overlaps the remove circle.
...
print("Prepared Circle/Square bubble implementation with live transparency and edge-touch delete activation")
