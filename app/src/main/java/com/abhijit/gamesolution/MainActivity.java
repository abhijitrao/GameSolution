...
public class MainActivity extends Activity {
    ...
    private void showUi() {
        ...
        addToggle("Recent App Bubble", "Show the previous app as a quick-switch bubble", BubbleSettings.isRecentAppBubbleEnabled(), enabled -> BubbleSettings.setRecentAppBubbleEnabled(this, enabled));
        addToggle("Activity Switch Bubble", "Enable switch bubbles from Current Activity Tracking", BubbleSettings.isActivitySwitchBubbleEnabled(), enabled -> BubbleSettings.setActivitySwitchBubbleEnabled(this, enabled));
