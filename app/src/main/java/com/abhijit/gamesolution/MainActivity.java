...
public class MainActivity extends Activity {
    ...
    private void showUi() {
        ...
        TextView bubbleSettings = text("BUBBLE SWITCHING", 11, secondary, Typeface.BOLD); bubbleSettings.setLetterSpacing(.12f); root.addView(bubbleSettings, lp(-1, -2, 0, dp(10), 0, 8));
        addToggle("Recent App Bubble", "Show the previous app as a quick-switch bubble", BubbleSettings.isRecentAppBubbleEnabled(this), enabled -> { BubbleSettings.setRecentAppBubbleEnabled(this, enabled); updateSecondaryBubbleService(); });
        addToggle("Activity Switch Bubble", "Display the current foreground activity", BubbleSettings.isActivitySwitchBubbleEnabled(this), enabled -> { BubbleSettings.setActivitySwitchBubbleEnabled(this, enabled); updateSecondaryBubbleService(); });
