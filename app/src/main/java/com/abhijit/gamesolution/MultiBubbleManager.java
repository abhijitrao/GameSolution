            ...
            @Override public boolean onTouch(View v, MotionEvent e) {
                switch (e.getActionMasked()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        vibrate(18);
                        if (!displayOnly) {
                            // Use the package currently represented by the bubble, not the package
                            // that existed when the touch listener was originally attached.
                            String currentPackage = (v == recentBubble && lastRecentPackage != null)
                                    ? lastRecentPackage : packageName;
